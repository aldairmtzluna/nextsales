...
public partial class DbventanexsalesContext : DbContext
{
    public DbventanexsalesContext()
    {
    }

    public DbventanexsalesContext(DbContextOptions<DbventanexsalesContext> options)
        : base(options)
    {
    }
